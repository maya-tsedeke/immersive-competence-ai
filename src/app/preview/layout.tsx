    ...
    <div className="min-h-screen overflow-x-hidden bg-[#0b1220]">
      <div className="mx-auto flex w-full max-w-lg flex-wrap items-center justify-between gap-2 px-4 py-3 text-white md:max-w-6xl">
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/dashboard"
            className="inline-flex min-h-[44px] items-center gap-2 text-sm font-semibold text-slate-200 hover:text-white"
          >
          ...
          <Link href="/" className="min-h-[44px] text-sm font-semibold text-slate-300 hover:text-white">
            Welcome
          </Link>
          <span className="hidden text-slate-500 sm:inline" aria-hidden>
            ·
          </span>
          <Link href="/preview/xr" className="min-h-[44px] text-sm font-semibold text-indigo-300 hover:text-white">
            XR
          </Link>
        </div>
        <PrototypeBadge
          usesGeneratedData={usesGenerated}
          className="border-white/20 bg-white/10 text-[10px] text-slate-100"
        />
      </div>
      {children}
    </div>
